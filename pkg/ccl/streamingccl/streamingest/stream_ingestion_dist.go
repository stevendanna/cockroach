...
//
// One note on the below results is that after I ran these, I noticed that the
// roachtests have metamorphic settings related to lease based expiration. I'm
// not sure how those impact these tests.
//
// # Test Runs
//
// tpcc w=500 with split:
//
...
//
// tpcc w=500 with split + scatter:
//
//   - About the same given the noise in this test. Makes _some_ sense to me since
//     we aren't co-locating the ranges.
//
// cluster_to_cluster.go:185: InitialScan Perf:
// cluster_to_cluster.go:187:     Duration Minutes : 6.21
// cluster_to_cluster.go:187:     Size_LogicalMegabytes : 37364.77
// cluster_to_cluster.go:187:     Size_PhysicalMegabytes : 10233.96
// cluster_to_cluster.go:187:     Size_PhysicalReplicatedMegabytes : 31446.30
// cluster_to_cluster.go:187:     Throughput_LogicalMegabytes_MB/S/Node : 25.08
// cluster_to_cluster.go:187:     Throughput_PhysicalMegabytes_MB/S/Node : 6.87
// cluster_to_cluster.go:187:     Throughput_PhysicalReplicatedMegabytes_MB/S/Node : 21.11// ... running
//
// tpcc w=500 with split + 3x processors:
//
// cluster_to_cluster.go:185: InitialScan Perf:
// cluster_to_cluster.go:187:     Duration Minutes : 4.53
// cluster_to_cluster.go:187:     Size_LogicalMegabytes : 37322.08
// cluster_to_cluster.go:187:     Size_PhysicalMegabytes : 10234.59
// cluster_to_cluster.go:187:     Size_PhysicalReplicatedMegabytes : 31383.72
// cluster_to_cluster.go:187:     Throughput_LogicalMegabytes_MB/S/Node : 34.31
// cluster_to_cluster.go:187:     Throughput_PhysicalMegabytes_MB/S/Node : 9.41
// cluster_to_cluster.go:187:     Throughput_PhysicalReplicatedMegabytes_MB/S/Node : 28.85
//
// tpcc w=500 with split + scatter + 3x processors:
//   - Scatter makes things worse?
//   - Not really sure what happened here.
//   - The last 3 minutes of this initial scan seemed to be some long-tail effect.
//
// cluster_to_cluster.go:185: InitialScan Perf:
// cluster_to_cluster.go:187:     Duration Minutes : 8.64
// cluster_to_cluster.go:187:     Size_LogicalMegabytes : 37445.14
// cluster_to_cluster.go:187:     Size_PhysicalMegabytes : 10258.63
// cluster_to_cluster.go:187:     Size_PhysicalReplicatedMegabytes : 31708.47
// cluster_to_cluster.go:187:     Throughput_LogicalMegabytes_MB/S/Node : 18.05
// cluster_to_cluster.go:187:     Throughput_PhysicalMegabytes_MB/S/Node : 4.95
// cluster_to_cluster.go:187:     Throughput_PhysicalReplicatedMegabytes_MB/S/Node : 15.29
//
// As compared to what the nightly sees on the same test:
//
// cluster_to_cluster.go:181: InitialScan Perf:
// cluster_to_cluster.go:183: 	Duration Minutes : 8.62
// cluster_to_cluster.go:183: 	Size_LogicalMegabytes : 37343.38
// cluster_to_cluster.go:183: 	Size_PhysicalMegabytes : 10231.08
// cluster_to_cluster.go:183: 	Size_PhysicalReplicatedMegabytes : 31448.77
// cluster_to_cluster.go:183: 	Throughput_LogicalMegabytes_MB/S/Node : 18.05
// cluster_to_cluster.go:183: 	Throughput_PhysicalMegabytes_MB/S/Node : 4.95
// cluster_to_cluster.go:183: 	Throughput_PhysicalReplicatedMegabytes_MB/S/Node : 15.20
//
// I have left TODOs in the function about things I noted, but I think the next
// step is to probably run this on top of the new instrumentation.
