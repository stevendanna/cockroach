...
var (
	...
	_ Details = ActiveReplicationDetails{}
)
...
var (
	...
	_ ProgressDetails = ActiveReplicationProgress{}
)
...
func DetailsType(d isPayload_Details) (Type, error) {
	...
	case *Payload_ActiveReplicationDetails:
		return TypeActiveReplication, nil
	default:
...
var JobDetailsForEveryJobType = map[Type]Details{
	...
	TypeActiveReplication:            ActiveReplicationDetails{},
}
...
func WrapProgressDetails(details ProgressDetails) interface {
	...
	case ActiveReplicationProgress:
		return &Progress_ActiveReplicationProgress{ActiveReplicationProgress: &d}
	default:
...
func (p *Payload) UnwrapDetails() Details {
	...
	case *Payload_ActiveReplicationDetails:
		return *d.ActiveReplicationDetails
	default:
		return nil
	}
}
...
func (p *Progress) UnwrapDetails() ProgressDetails {
	...
	case *Progress_ActiveReplicationProgress:
		return *d.ActiveReplicationProgress
	default:
		return nil
	}
}
...
func WrapPayloadDetails(details Details) interface {
	...
	case ActiveReplicationDetails:
		return &Payload_ActiveReplicationDetails{ActiveReplicationDetails: &d}
	default:
