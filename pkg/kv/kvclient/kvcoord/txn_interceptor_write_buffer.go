...
func (twb *txnWriteBuffer) flushWithEndTxn(
	...
	// TODO(ssd): Layers below us expect that writes inside a batch are in
	// sequence number order but the iterator above returns data in key order.
	// Here we resort it which is rather unfortunate.
